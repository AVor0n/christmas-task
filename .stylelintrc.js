module.exports = {
  ...
  plugins: ['stylelint-order', 'stylelint-config-rational-order/plugin', 'stylelint-no-unsupported-browser-features'],
  rules: {
    ...
    'selector-class-pattern': '^[\\w]+(-[\\w\\d]+)*(__[\\w]+(-[\\w\\d]+)*)?(--[\\w]+(-[\\w\\d]+)*)?(:{1,2}.+)?$',
  },
